                                    ...
                                    int *numNewVerts)
{
    ...
    int enterExact = -1;	// Equals zero if vertArray[enterVert] lies exactly on the plane
    int exitExact = -1;		// Equals zero if vertArray[exitVert-1] lies exactly on the plane
