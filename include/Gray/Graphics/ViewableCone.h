...
public:
    ...
    {
        SetSlopes(slope,slope);   // Makes it a circular cone with that radius
    }
    ...
    // Get routines
    void GetApex( double* apex ) const
    {
        Apex.Dump( apex );
    }
    void GetApex( float* apex ) const
    {
        Apex.Dump( apex ) ;
    }
    const VectorR3& GetApex() const
    {
        return Apex;
    }
    void GetCenterAxis( double* center ) const
    {
        CenterAxis.Dump( center );
    }
    void GetCenterAxis( float* center ) const
    {
        CenterAxis.Dump( center );
    }
    const VectorR3& GetCenterAxis() const
    {
        return CenterAxis;
    }
    VectorR3 GetAxisA() const
    {
        return AxisA/SlopeA;
    }
    ...
    void GetInvScaledAxisA( double* axisA ) const
    {
        AxisA.Dump( axisA );
    }
    void GetInvScaledAxisA( float* axisA ) const
    {
        AxisA.Dump( axisA );
    }
    const VectorR3& GetInvScaledAxisA() const
    {
        return AxisA;
    }
    void GetInvScaledAxisB( double* axisB ) const
    {
        AxisB.Dump( axisB );
    }
    void GetInvScaledAxisB( float* axisB ) const
    {
        AxisB.Dump( axisB );
    }
    const VectorR3& GetInvScaledAxisB() const
    {
        return AxisB;
    }
    double GetSlopeA( ) const
    {
        return SlopeA;
    }
    double GetSlopeB( ) const
    {
        return SlopeB;
    }
