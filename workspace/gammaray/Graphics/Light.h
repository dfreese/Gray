...
public:
    ...
    void ResetAttenuate();
    bool AttenuateActive() const
    {
        return AttenuateFlag;
    }
    double GetAttenuateConstant() const
    {
        return AttenuateConstant;
    }
    double GetAttenuateLinear() const
    {
        return AttenuateLinear;
    }
    double GetAttenuateQuadratic() const
    {
        return AttenuateQuadratic;
    }
    void GetAttenuate( double* coefs ) const;
    void GetAttenuate( float* coefs ) const;

    bool SpotActive() const
    {
        return SpotlightFlag;
    }
    void ResetSpotlight();
    ...
    const VectorR3& GetSpotDirection() const
    {
        return SpotDirection;
    }
    double GetSpotCutoff()  const
    {
        return SpotCutoffCosine;
    }
    double GetSpotCutoffAngle()  const
    {
        return acos(SpotCutoffCosine);
    }
    double GetSpotExponent()  const
    {
        return SpotAttenuate;
    }
