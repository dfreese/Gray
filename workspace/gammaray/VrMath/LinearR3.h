...
public:
    ...
    bool NearZero(double tolerance) const
    {
    ...
    double YaxisDistSq() const
    {
        return (x*x+z*z);
    }
    double YaxisDist() const
    {
        return sqrt(x*x+z*z);
    }
...
inline double InnerProduct(const VectorR3& u, const VectorR3& v )
{
    return (u^v);
}
...
public:
    ...
    void RightMultiplyByTranspose( const Matrix3x3& M )
    {
        Matrix3x3::RightMultiplyByTranspose(M);
    }
    void LeftMultiplyBy( const Matrix3x3& M )
    {
        Matrix3x3::LeftMultiplyBy(M);
    }
    void LeftMultiplyByTranspose( const Matrix3x3& M )
    {
        Matrix3x3::LeftMultiplyByTranspose(M);
    }
...
public:
    ...
    {
        Matrix3x4::ApplyXRotationLeft( theta );
        return *this;
    }
    AffineMapR3& ApplyXRotationLeft( double costheta, double sintheta )
    {
        Matrix3x4::ApplyXRotationLeft( costheta, sintheta );
        return *this;
    }
...
public:
    ...
    void RightMultiplyByTranspose( const RotationMapR3& M )
    {
        Matrix3x3::RightMultiplyByTranspose(M);
    }
    void LeftMultiplyBy( const RotationMapR3& M )
    {
        Matrix3x3::LeftMultiplyBy(M);
    }
    void LeftMultiplyByTranspose( const RotationMapR3& M )
    {
        Matrix3x3::LeftMultiplyByTranspose(M);
    }
