...
public:
    ...
    VectorR4 operator- () const
    {
        return ( VectorR4(-x, -y, -z, -w) );
    }
...
inline double Mag(const VectorR4& u)
{
    return u.Norm();
}
inline double Dist(const VectorR4& u, const VectorR4& v)
{
    return u.Dist(v);
}
