...
public:
	...
	bool SetBinning(bool b) { binEvents = b; };
...
void inline Coincidence::SetTimeGate(double t) { time_window = t; }
void inline Coincidence::SetDelayedTimeOffset(double t) { delayed_time_window_offset = t; }
void inline Coincidence::SetEnergyGate(double lower, double upper) { energy_gate_lower = lower; energy_gate_upper = upper; }
void inline Coincidence::Set2D(unsigned int ring_diff) { ring_difference = ring_diff; gate2D = true; }
