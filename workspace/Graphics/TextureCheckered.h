...
{
public:
    TextureCheckered() : Material1(0),Material2(0)
    {
        SetWidths(0.5,0.5);
    }
    ...
    void SetMaterial1( const MaterialBase* mat1 )
    {
        Material1 = mat1;
    }
    void SetMaterial2( const MaterialBase* mat2 )
    {
        Material2 = mat2;
    }

    const MaterialBase* GetMaterial1() const
    {
        return Material1;
    }
    const MaterialBase* GetMaterial2() const
    {
        return Material2;
    }
