...
public:
    ...
    BezierArray& GetPatchList()
    {
        return OriginalPatches;
    }
    const BezierArray& GetPatchList() const
    {
        return OriginalPatches;
    }
    BezierArray& GetInteralPatchList()
    {
        return PatchList;
    }
    const BezierArray& GetInteralPatchList() const
    {
        return PatchList;
    }
...
public:
    ...
    const VectorR4* GetControlPoints( ) const
    {
        return &CntlPts[0][0];
    }
...
protected:
    ...
    bool IsSplitIntoTwo() const
    {
        return (SplitPatchA!=0);
    }
