...
public:
    ...
    {
        SetRadii(radius,radius);   // Makes it a circular cylinder with that radius
    }
    ...
    {
        return RadiusA*AxisA;
    }
    const VectorR3 GetAxisB() const
    {
        return RadiusB*AxisB;
    }
    // InvScaled Axis A values are scaled by (1/RadiusA).
    void GetInvScaledAxisA( double* center ) const
    {
        AxisA.Dump( center );
    }
    void GetInvScaledAxisA( float* center ) const
    {
        AxisA.Dump( center );
    }
    ...
    void GetInvScaledAxisB( double* center ) const
    {
        AxisB.Dump( center );
    }
    void GetInvScaledAxisB( float* center ) const
    {
        AxisB.Dump( center );
    }
    ...
    {
        *planenormal = BottomNormal;
        *planeCoef = BottomPlaneCoef;
    }
