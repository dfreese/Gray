...
#ifdef GAMMA_PHYSICS
	unsigned GetDetectorId() const { return detector_id; }
	void SetDetectorId(unsigned id) {detector_id = id; }
	void SetSrcId(unsigned char id) {src_id = id; }
	unsigned char GetSrcId() const { return src_id; }
#endif
