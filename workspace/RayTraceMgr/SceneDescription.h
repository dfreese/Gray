...
#ifdef GAMMA_PHYSICS
	int NumGammaStats() const { return GammaStatsArray.SizeUsed(); }
	int AddGammaStats( GammaStats* stats );
	const GammaStats& GetGammaStats( int i ) const { return *GammaStatsArray[i]; }
	Array<GammaStats*>& GetGammaStatsArray() { return GammaStatsArray; }
