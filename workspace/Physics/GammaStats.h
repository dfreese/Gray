...
inline int GammaStats::GetNumEscape() { return num_escape; }
inline double * GammaStats::GetXrayEscape() { return xray_escape; }
inline double * GammaStats::GetXrayEscapeProb() {return xray_escape_probability; }
inline double GammaStats::GetAugerProb(int i) { return auger[i]; }
