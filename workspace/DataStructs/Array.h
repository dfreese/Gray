...
public:
    ...
    void PreallocateMore( long numAdditional )
    {
        Resize( SizeUsed()+numAdditional );
    }
    ...
    bool IsEmpty() const
    {
        return (MaxEntryPlus==0);
    }

    void DisallowDynamicResizing()
    {
        DynamicResizingOK = false;
    }
    void AllowDynamicResizing()
    {
