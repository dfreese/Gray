...
public:
	...
	// ******** Accessors ****************
	const KdTreeNode& GetNode( long i ) const { return TreeNodes[i]; }
...
private:
	...
	long RootIndex() const { return 0; }
	long NextIndex() { long i = TreeNodes.SizeUsed(); TreeNodes.Touch(i); return i; }
