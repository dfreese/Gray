...
public:
    ...
    bool IsEmpty() const
    {
        return RootElt->GetNext()->IsRoot();
    }
    CLinkedListElt<T>* GetRoot() const
    {
        return RootElt;
    }
    CLinkedListElt<T>* GetFirst() const
    {
        return RootElt->GetNext();
    }
    CLinkedListElt<T>* GetLast() const
    {
        return RootElt->GetPrev();
    }
